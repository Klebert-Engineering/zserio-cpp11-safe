...
public:
    ...
    const ::zserio::vector<::minizs::Inner>& getInner() const;
    ::zserio::vector<::minizs::Inner>& getInner();
...
private:
    ...
    using ZserioArrayType_inner = ::zserio::Array<::zserio::vector<::minizs::Inner>, ::zserio::ObjectArrayTraits<::minizs::Inner, ZserioElementFactory_inner>, ::zserio::ArrayType::NORMAL>;
